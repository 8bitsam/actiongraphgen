...
# -*- coding: utf-8 -*-
#
# actiongraphgen documentation build configuration file, created by
...
modindex_common_prefix = ["actiongraphgen"]
...
basename = "actiongraphgen".replace(" ", "").replace(".", "")
...
latex_documents = [
    ("index", "actiongraphgen.tex", "actiongraphgen Documentation", ab_authors, "manual"),
]
...
man_pages = [("index", "actiongraphgen", "actiongraphgen Documentation", ab_authors, 1)]
