...
def generate_graph(terminal_matrix):
    ...
    while current_node >= 0:
        ...
        parents = random.choices(range(current_node + 1, MAX_NODES), k=num_parents)
        
        # Check for arc-consistency and mathematical validity before adding the node
...
def is_valid_node(parents, operation):
    ...
    # Perform arc-consistency checks based on the operation
